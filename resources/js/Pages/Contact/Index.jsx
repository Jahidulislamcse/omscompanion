...
export default function Index({ settings = {} }) {
    ...
    return (
        <div className="landing-wrapper page-colorful-theme" style={{ backgroundColor: '#0f172a', color: '#ffffff' }}>
            ...
            {/* Header Navigation */}
            <header className="glass-panel landing-header header-sticky" style={{ backgroundColor: 'rgba(15, 23, 42, 0.85)' }}>
                ...
                <nav className={`landing-nav ${mobileNavOpen ? 'mobile-nav-open' : ''}`}>
                    ...
                    <Link href={route('contact')} className="nav-link-item active-nav-item" onClick={() => setMobileNavOpen(false)}>CONTACT</Link>
